#ifndef _ROS_moveit_simple_grasps_GenerateGraspsFeedback_h
#define _ROS_moveit_simple_grasps_GenerateGraspsFeedback_h
...
namespace moveit_simple_grasps
{
  ...
  class GenerateGraspsFeedback : public ros::Msg
  {
    ...
    const char * getType(){ return "moveit_simple_grasps/GenerateGraspsFeedback"; };
