#ifndef _ROS_cob_perception_msgs_PositionMeasurementArray_h
#define _ROS_cob_perception_msgs_PositionMeasurementArray_h
...
namespace cob_perception_msgs
{
  ...
  class PositionMeasurementArray : public ros::Msg
  {
    public:
      ...
      typedef cob_perception_msgs::PositionMeasurement _people_type;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      if(people_lengthT > people_length)
        this->people = (cob_perception_msgs::PositionMeasurement*)realloc(this->people, people_lengthT * sizeof(cob_perception_msgs::PositionMeasurement));
      people_length = people_lengthT;
      for( uint32_t i = 0; i < people_length; i++){
      offset += this->st_people.deserialize(inbuffer + offset);
        memcpy( &(this->people[i]), &(this->st_people), sizeof(cob_perception_msgs::PositionMeasurement));
      }
    ...
    const char * getType(){ return "cob_perception_msgs/PositionMeasurementArray"; };
    const char * getMD5(){ return "f76f3d050aeed243c9f1fbf9cfa040ee"; };
