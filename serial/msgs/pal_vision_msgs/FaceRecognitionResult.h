#ifndef _ROS_pal_vision_msgs_FaceRecognitionResult_h
#define _ROS_pal_vision_msgs_FaceRecognitionResult_h
...
namespace pal_vision_msgs
{
  ...
  class FaceRecognitionResult : public ros::Msg
  {
    ...
    const char * getType(){ return "pal_vision_msgs/FaceRecognitionResult"; };
