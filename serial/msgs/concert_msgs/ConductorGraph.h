...
namespace concert_msgs
{
  ...
  class ConductorGraph : public ros::Msg
  {
    public:
      ...
      uint32_t bad_length;
      typedef concert_msgs::ConcertClient _bad_type;
      _bad_type st_bad;
      _bad_type * bad;
      uint32_t blocking_length;
      typedef concert_msgs::ConcertClient _blocking_type;
      _blocking_type st_blocking;
      _blocking_type * blocking;
      uint32_t busy_length;
      typedef concert_msgs::ConcertClient _busy_type;
      _busy_type st_busy;
      _busy_type * busy;
      uint32_t uninvited_length;
      typedef concert_msgs::ConcertClient _uninvited_type;
      _uninvited_type st_uninvited;
      _uninvited_type * uninvited;
      uint32_t joining_length;
      typedef concert_msgs::ConcertClient _joining_type;
      _joining_type st_joining;
